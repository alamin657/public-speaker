                            ...
                            <div class="card">
                                ...
                                <div class="card-content">
                                    <div class="card-body">
                                        ...
                                        <a href={{route('admin-portfolio.create')}} class="btn btn-primary mb-2  align-items-center"> Create
                                            </a>
                                                        ...
                                                        <th></th>
                                                         <td>
                                                            ...
                                                            <div class="dropdown-menu dropdown-menu-right">
                                                                    ...
                                                                    <form action="{{ route('admin-portfolio.destroy',$portfolio->id) }}" method="post"> @csrf @method('Delete')
