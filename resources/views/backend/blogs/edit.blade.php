                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                ...
                                <form method="post" action="{{ route('admin-blog.update',$blogs->id) }}" enctype="multipart/form-data">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div >
                                            <label>Title</label>
                                                <input value="{{$blogs -> title}}" type="text" name="title" class="form-control" id="inputGroupFile04" aria-describedby="inputGroupFileAddon04" required>
                                            <label class="mt-3">Sub Title</label>
                                                <input value="{{$blogs -> sub_title}}" type="text" name="sub_title" class="form-control" id="inputGroupFile04" aria-describedby="inputGroupFileAddon04" required>
                                            <label class="mt-3">Description</label>
                                                <input value="{{$blogs -> description}}" type="text" name="description" class="form-control" id="inputGroupFile04" aria-describedby="inputGroupFileAddon04" required>
                                         </div>
                                          {{-- image update     @if($gallery->image != null)    @endif--}}
                                         <div>
                                            <label for=""> Image </label>
                                            <img src="{{ asset('images/blogs/'.$blogs->image) }}" id="output" alt="img" width="100px" height="auto" class="mt-2 mx-1">
                                            <input type="file" name="image" class="form-control mt-2" id="inputGroupFile04" aria-describedby="inputGroupFileAddon04" aria-label="Upload" value="{{ $blogs->image }}" >
