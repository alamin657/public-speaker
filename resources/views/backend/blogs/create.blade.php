                               ...
                               <form method="post" action="{{ route('admin-blog.store') }}" enctype="multipart/form-data">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="table-responsive">
                                           <div>
                                            <label>Title</label>
                                                <input type="text" name="title" class="form-control" id="inputGroupFile04" placeholder="Please Title  here" aria-describedby="inputGroupFileAddon04" required>
                                             
                                            <label>Sub Title</label>
                                                <input type="text" name="sub_title" class="form-control" id="inputGroupFile04" placeholder="Please Sub title  here" aria-describedby="inputGroupFileAddon04" required>
                                             
                                            <label>Description</label>
                                                <textarea type="text" name="description" class="form-control" placeholder="Please description  here" id="floatingTextarea" aria-describedby="inputGroupFileAddon04"  col="10" rows="5" required></textarea>
                                                {{-- <input type="text" name="description" class="form-control" id="inputGroupFile04" aria-describedby="inputGroupFileAddon04" required> --}}
