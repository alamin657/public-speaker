                                ...
                                <form method="post" action="{{ route('admin-counter.update', $counter->id) }}" enctype="multipart/form-data">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="table-responsive">
                                           <div >
                                                <h3>Name</h3>
                                                <input value="{{$counter -> name}}" type="text" name="name" class="form-control" id="inputGroupFile04" aria-describedby="inputGroupFileAddon04" required><br>
                                                <h3>Number</h3>
                                                <input value="{{$counter -> number}}" type="text" name="number" class="form-control" id="inputGroupFile04" aria-describedby="inputGroupFileAddon04" required><br>
                                                {{-- <h3>Failed</h3>
