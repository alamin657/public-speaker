                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">Portfolio Category List</h4>
                                </div>
                                <div class="card-content">
                                    <div class="card-body">
                                        <p class="card-text">
                                        </p>
                                        <a href="{{route('portfoloioCategory.create')}}" class="btn btn-primary mb-2  align-items-center"> Create
                                                        ...
                                                        <th></th>
                                                         <td>
                                                            ...
                                                            <div class="dropdown-menu dropdown-menu-right">
                                                                ...
                                                                <a href="{{route('portfoloioCategory.edit',$portfoliocategory->id)}}" class="dropdown-item">
                                                                 
                                                                        <i class="bx bx-edit-alt mr-1"></i> Edit
                                                                </a>

                                                             
                                                                    <form action="{{route('portfoloioCategory.destroy',$portfoliocategory->id)}}" method="post"> 
                                                                    @csrf @method('Delete') 
