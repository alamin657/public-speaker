                            ...
                            <div class="card">
                                ...
                                <div class="card-content">
                                    <div class="card-body">
                                        ...
                                        <a href={{route('admin-banner.create')}} class="btn btn-primary mb-2  align-items-center"> Create
                                            </a>
                                            ...
                                            <table class="table add-rows">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <img src="{{ asset('images/banner/'.$banner->image) }}" id="output" alt="img" width="100px" height="auto" class="mt-2 mx-1">
                                                        ...
                                                        <th></th>
                                                         <td>
                                                            ...
                                                            <div class="dropdown-menu dropdown-menu-right">
                                                                ...
                                                                <a href="{{ route('admin-banner.edit', $banner->id) }}" class="dropdown-item">
                                                                        <i class="bx bx-edit-alt mr-1"></i> Edit
                                                                </a>

                                                             
                                                                    <form action="{{ route('admin-banner.destroy',$banner->id) }}" method="post"> @csrf @method('Delete')
