                            ...
                            <div class="card">
                                ...
                                <div class="card-content">
                                    <div class="card-body">
                                        ...
                                        <a href={{route('admin-project.create')}} class="btn btn-primary mb-2  align-items-center"> Create
                                            </a>
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            {{-- @else
                                                            <img src="{{ asset('images/project/'.$project->image) }}" id="output" alt="img" width="200px" height="auto" class="mt-2 mx-1">
                                                            @endif --}}
                                                        </td>
                                                        <td></td>
                                                        <td></td>
                                                         <td>
                                                            ...
                                                            <div class="dropdown-menu dropdown-menu-right">
                                                                ...
                                                                <a href="{{ route('admin-project.edit', $project->id) }}" class="dropdown-item">
                                                                        <i class="bx bx-edit-alt mr-1"></i> Edit
                                                                </a>

                                                             
                                                                    <form action="{{ route('admin-project.destroy',$project->id) }}" method="post"> @csrf @method('Delete')
