                                ...
                                <form method="POST" action="{{route('admin-project.update', $project->id)}}" enctype="multipart/form-data">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="table-responsive">
                                           <div >
                                            <h3>Title</h3>
                                                <input value="{{$project -> title}}" type="text" name="title" class="form-control" id="inputGroupFile04" aria-describedby="inputGroupFileAddon04" required>
                                            <h3 class="mt-3">Video</h3>
                                                <input value="{{$project -> url}}" type="text" id="video" name="video" class="form-control" aria-describedby="basic-Createon1"  onchange="loadFile(event)" required>
                                        </div>
                                          {{-- image update     @if($project->image != null)    @endif--}}
                                      
                                        {{-- <img src="{{ asset('images/project/'.$project->image) }}" id="output" alt="img" width="100px" height="auto" class="mt-2 mx-1"> --}}
