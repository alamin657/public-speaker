                                ...
                                <form method="POST" action="{{route('admin-skill.update', $skill-> id)}}" enctype="multipart/form-data">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="table-responsive">
                                           <div >
                                            <h3>Name</h3>
                                                <input value="{{$skill -> name}}" type="text" name="name" class="form-control" id="inputGroupFile04" aria-describedby="inputGroupFileAddon04" required>
                                            <h3 class="mt-3">Skills</h3>
                                               <input value="{{$skill -> number}}" type="number" name="number" class="form-control" id="inputGroupFile04" aria-describedby="inputGroupFileAddon04" required>
                                        </div>
