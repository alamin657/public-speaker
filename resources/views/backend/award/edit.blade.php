                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                ...
                                <form method="post" action="{{ route('admin-award.update',$award->id) }}" enctype="multipart/form-data">
                                    @csrf
                                    @method('put')
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="table-responsive">
                                           <div >
                                            <h3>Title</h3>
                                                <input value="{{$award -> title}}" type="text" name="title" class="form-control" id="inputGroupFile04" aria-describedby="inputGroupFileAddon04" required>
                                          ...
                                          {{-- image update     @if($award->image != null)    @endif--}}
