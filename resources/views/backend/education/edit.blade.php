                                    ...
                                    <div class="card-body">
                                        <p class="card-text">
                                         ...
                                         <div class="table-responsive">
                                           <div >
                                            <h5>Name</h5>
                                                <input value="{{$education -> name}}" type="text" name="name" class="form-control" id="inputGroupFile04" aria-describedby="inputGroupFileAddon04" required>
                                            <h5 class="mt-3">Title</h5>
                                            <input value="{{$education -> title}}" type="text" name="title" class="form-control" id="inputGroupFile04" aria-describedby="inputGroupFileAddon04" required>
                                            <h5 class="mt-3">Start Date</h5>
                                            <input type="date" value="{{$education -> start_date}}" name="start_date" class="form-control" id="inputGroupFile04" aria-describedby="inputGroupFileAddon04" required>
                                            <h5 class="mt-3">End Date</h5>
                                            <input value="{{$education -> end_date}}" type="date" name="end_date" class="form-control" id="inputGroupFile04" aria-describedby="inputGroupFileAddon04">
                                            <h5 class="mt-3">Description</h5>
                                            <input value="{{$education -> description}}" type="text"  name="description" class="form-control" id="inputGroupFile04" aria-describedby="inputGroupFileAddon04">
                                        </div>
