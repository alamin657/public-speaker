                            ...
                            <div class="card">
                                ...
                                <div class="card-content">
                                    <div class="card-body">
                                        ...
                                        <a href="{{route('admin-education.create')}}" class="btn btn-primary mb-2  align-items-center"> Create
                                            </a>
                                            ...
                                            <table class="table add-rows">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                       ...
                                                       <th>{{ $education-> start_date}}</th>
                                                        <th>{{ $education-> end_date}}</th>
                                                        ...
                                                        <th>{{$education -> description}}</th>
                                                         <td>
                                                            ...
                                                            <div class="dropdown-menu dropdown-menu-right">
                                                                ...
                                                                <a href="{{route('admin-education.edit', $education->id)}}" class="dropdown-item">
